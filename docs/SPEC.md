...
| **P7** | 데이터 모니터링 | 데이터 누락 알림 배너, 이벤트 마커, 싱크 버튼 | ⏳ 7.1~7.2 완료, 7.4 DataStatusPanel 완료(`8ec127c`), 7.3·7.5 미구현 |
...
| **P11** | 고도화 | AI 인사이트, 월별 요약, 보고서 내보내기, Telegram 알림 | ✅ Telegram cron + 인사이트 완료. 보고서 내보내기는 미구현 |
